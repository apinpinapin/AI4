...
├── Admin WA 1  : 0895 32800 5151
├── Admin WA 2  : 0895 0142 7163
╰───────────────────────────✦ */


const apikey_autoresbot = 'apiku2';
const cap               = 'Buddy'
const grubwa            = 'https://chat.whatsapp.com/KJD2nB7j7lfHux9AVQCra4'
const autoresbot_version= 'autoresbot v1.0.3'
...
const onlygc = () => {
    ...
    autoresbot.sendMessage(m.chat, {
        text: `👋🏻 Hai kak ${pushname} Untuk Memulai Menggunakan Bot, diharapkan bergabung ke grub terlebih dahulu ya.

_Jangan lewatkan kesempatan untuk mendapatkan file script! Cukup ketik ${prefix}menu di grup bot._
...
let teks = `¥ Price Sewa Bot Autoresbot €
...
Link Pembayaran :
autoresbot.com/qris.jpg

Dan Konfirmasi Ke Admin
wa.me/62895328005151?text=helomin+mau+konfirmasi+id+grub+${cret.id}
...
if (resbot_.isBan) return reply('*Mohon maaf, saat ini nomor kamu sudah di baned dari bot ini*')
            ...
            autoresbot.sendImageAsSticker(from, rest.result, m, { packname: `${global.packname}`, author: `${global.author}`})
            }
break
